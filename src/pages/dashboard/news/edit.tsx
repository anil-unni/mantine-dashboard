  ...
  React.useEffect(() => {
    if (news) {
      form.setValues({
        ...
        mobile_banner_image: news.mobile_banner_image,
        banner_image_alt: news.banner_image_alt,
        thumbnail: news.thumbnail,
        thumbnail_alt: news.thumbnail_alt,
        ...
        seodetails: news.seodetails,
        isActive: news.isActive,
      });
    }
  }, [news]);

  const handleSubmit = async (values: NewsUpdateRequest) => {
    try {
      await updateNewsMutation.mutateAsync({ id: id!, data: values });
